...
win32 {
    RC_ICONS = icons/crt.ico
    DEFINES += NOMINMAX WIN32_LEAN_AND_MEAN
    # Large object files needed for compiled-in fonts and shaders
    QMAKE_CXXFLAGS += /bigobj
    # KDSingleApplication requires advapi32 (GetUserNameW)
    LIBS += -ladvapi32
}

RESOURCES += qml/resources.qrc \
             qml/resources_fonts1.qrc \
             qml/resources_fonts2.qrc \
             qml/resources_fonts3.qrc \
             qml/resources_shaders.qrc

# Shader compilation (Qt Shader Baker)
QSB_BIN = $$[QT_HOST_BINS]/qsb
isEmpty(QSB_BIN): QSB_BIN = $$[QT_INSTALL_BINS]/qsb

# On Windows, qsb might have .exe extension
win32:QSB_BIN = $${QSB_BIN}.exe
