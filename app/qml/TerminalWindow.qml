...
ApplicationWindow {
    ...
    // On Windows, use an opaque black background to avoid transparent bleed-through
    // (Windows/DWM doesn't always composite the shader effects correctly over transparency).
    // On Linux/macOS, keep the transparent background so windowOpacity can blend with desktop.
    color: appSettings.isWindows ? "#000000" : "#00000000"
